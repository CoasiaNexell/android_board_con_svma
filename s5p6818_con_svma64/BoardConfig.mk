...
DTB_OUTDIR := out/target/product/s5p6818_con_svma64/obj/KERNEL_OBJ
DTB_DIR := ${DTB_OUTDIR}/arch/arm64/boot/dts/nexell
DTIMG_ARG := ${DTB_DIR}/s5p6818-con_svma-rev01.dtb --id=1
BOARD_PREBUILT_DTBOIMAGE := out/target/product/s5p6818_con_svma64/dtbo_con_svma.img
...
BOOT_LOGO := device/nexell/con_svma/s5p6818_con_svma64/logo.bmp
...
UBOOT_BOOTARGS+=blkdevparts=mmcblk0:4915200@66048(bootloader_a),4915200@5046784(bootloader_b),62914560@11075584(boot_a),2097152@73990114(extended),62914560@75038720(boot_b),3145728@139001856(dtbo_a),3145728@143196160(dtbo_b),2147483648@147390464(system_a),2147483648@2295922688(system_b),268435456@4444454912(vendor_a),268435456@4713938944(vendor_b),1048576@4983422976(misc),3145728@4985520128(product),2827419648@4989714432(userdata)
...
TARGET_RECOVERY_WIPE = device/nexell/con_svma/s5p6818_con_svma64/recovery.wipe
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 2827419648
...
DEVICE_MANIFEST_FILE := device/nexell/con_svma/s5p6818_con_svma64/manifest.xml
DEVICE_PACKAGE_OVERLAYS := device/nexell/con_svma/s5p6818_con_svma64/overlay

#sepolicy
BOARD_SEPOLICY_DIRS := device/nexell/con_svma/s5p6818_con_svma64/sepolicy/vendor
BOARD_PLAT_PUBLIC_SEPOLICY_DIR := device/nexell/con_svma/s5p6818_con_svma64/sepolicy/public
BOARD_PLAT_PRIVATE_SEPOLICY_DIR := device/nexell/con_svma/s5p6818_con_svma64/sepolicy/private

# graphics
BOARD_EGL_CFG := device/nexell/con_svma/s5p6818_con_svma64/egl.cfg
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/nexell/con_svma/s5p6818_con_svma64/bluetooth
BOARD_CUSTOM_BT_CONFIG := device/nexell/con_svma/s5p6818_con_svma64/bluetooth/vnd_con_svma_s5p6818.txt
...
#recovery
TARGET_RECOVERY_FSTAB := device/nexell/con_svma/s5p6818_con_svma64/fstab.con_svma
