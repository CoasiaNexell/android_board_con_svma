...
DTB_OUTDIR := out/target/product/nxp4330_con_svma/obj/KERNEL_OBJ
...
BOARD_PREBUILT_DTBOIMAGE := out/target/product/nxp4330_con_svma/dtbo_con_svma.img
...
#nonsecure=UBOOT_BIN
#param=PARAM_BIN
BOOT_LOGO := device/nexell/con_svma/nxp4330_con_svma/logo.bmp
...
TARGET_RECOVERY_WIPE = device/nexell/con_svma/nxp4330_con_svma/recovery.wipe
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 4975951872
...
DEVICE_MANIFEST_FILE := device/nexell/con_svma/nxp4330_con_svma/manifest.xml
DEVICE_PACKAGE_OVERLAYS := device/nexell/con_svma/nxp4330_con_svma/overlay

#sepolicy
BOARD_SEPOLICY_DIRS := device/nexell/con_svma/nxp4330_con_svma/sepolicy/vendor
BOARD_PLAT_PUBLIC_SEPOLICY_DIR := device/nexell/con_svma/nxp4330_con_svma/sepolicy/public
BOARD_PLAT_PRIVATE_SEPOLICY_DIR := device/nexell/con_svma/nxp4330_con_svma/sepolicy/private

# graphics
BOARD_EGL_CFG := device/nexell/con_svma/nxp4330_con_svma/egl.cfg
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/nexell/con_svma/nxp4330_con_svma/bluetooth
BOARD_CUSTOM_BT_CONFIG := device/nexell/con_svma/nxp4330_con_svma/bluetooth/vnd_con_svma_s5p4418.txt
