...
DTB_OUTDIR := out/target/product/s5p6818_con_svma_auto/obj/KERNEL_OBJ
DTB_DIR := ${DTB_OUTDIR}/arch/arm64/boot/dts/nexell
DTIMG_ARG := ${DTB_DIR}/s5p6818-con_svma_auto-rev01.dtb --id=1
BOARD_PREBUILT_DTBOIMAGE := out/target/product/s5p6818_con_svma_auto/dtbo_con_svma.img
...
TARGET_RECOVERY_WIPE = device/nexell/con_svma/s5p6818_con_svma_auto/recovery.wipe
...
DEVICE_MANIFEST_FILE := device/nexell/con_svma/s5p6818_con_svma_auto/manifest.xml

#sepolicy
BOARD_SEPOLICY_DIRS := device/nexell/con_svma/s5p6818_con_svma_auto/sepolicy/vendor
BOARD_PLAT_PUBLIC_SEPOLICY_DIR += device/nexell/con_svma/s5p6818_con_svma_auto/sepolicy/public
BOARD_PLAT_PRIVATE_SEPOLICY_DIR += device/nexell/con_svma/s5p6818_con_svma_auto/sepolicy/private

# graphics
BOARD_EGL_CFG := device/nexell/con_svma/s5p6818_con_svma_auto/egl.cfg
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/nexell/con_svma/s5p6818_con_svma_auto/bluetooth
BOARD_CUSTOM_BT_CONFIG := device/nexell/con_svma/s5p6818_con_svma_auto/bluetooth/vnd_con_svma_s5p6818.txt
